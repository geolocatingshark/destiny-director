...
> - **The in-Discord builder stays for one release** behind an "Edit in Discord instead"
>   button on the handoff message. Delete `cv2_builder.py`, its fallbacks in `posts.py`
>   (`_build_in_discord`, `_edit_cv2_in_discord`, `_copy_cv2_in_discord`) and this note
>   once the web flow has been used for real.
